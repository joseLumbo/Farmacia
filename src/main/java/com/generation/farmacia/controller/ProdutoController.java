...
//estamos a criar uma classe responsavel por responder as requisições
@RestController
//criando o endereço
@RequestMapping("/produtos")
//criando as anotaçoes para comunicar-se com o front end (React ou Angular)(O * é o dominio)
@CrossOrigin(origins = "*",allowedHeaders = "*")
public class ProdutoController {
	
	//Injenção de dependecia dos metodos da Jpa para criar e instanciar atraves deste repositorio
	@Autowired
	private ProdutoRepository produtoRepository; //criando uma instancia no controller para conectar com o nosso produto repositorio
	
	@Autowired
	private CategoriaRepository categoriaRepository;
	
	//procurar os dados pela Jpa
	@GetMapping
